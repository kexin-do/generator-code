...
public abstract class StringUtils {
    ...
    public static String arrayToCamelString(@NonNull String str){
        if(str == null || str.length() == 0){
            return null;
        }
        final String[] arr = str.split("_");
        ...
        for (int i = 1; i < arr.length; i++) {
            ...
            if(current.length() == 1){
                ...
                sb.append(Character.toUpperCase(current.charAt(0))+current.substring(1).toLowerCase());
            }
        }
